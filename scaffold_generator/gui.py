...
class ScaffoldApp:
    ...
    def create_widgets(self):
        ...
        ttk.Checkbutton(
            self.root,
            text="Create virtual enviroment",
        ...
        self.generate_btn = ttk.Button(
            self.root, text="Generate Project", command=self.generate
        )
    ...
    def generate(self):
        ...
        try:
            ...
            self.status_label.config(
                text=f"Project '{name}' created!", foreground="green"
            )
    ...
    def update_preview(self, *args):
        ...
        extras = ["\n Optional Actions:"]
        extras.append(
            f"{'✓' if self.venv_var.get() else '✗'} Create virtual environment"
        )
